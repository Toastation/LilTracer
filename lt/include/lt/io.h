/**
 * @file
 * @brief Contains functions for generating scenes and rendering them from JSON descriptions.
 */
...
namespace LT_NAMESPACE {
	 ...
	 * 
	 * This function parses a JSON description of a scene and generates the corresponding Scene and Renderer objects.
	 * 
