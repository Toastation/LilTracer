...
namespace LT_NAMESPACE {
	...
	public:
		 ...
		 * Initializes normal and position to zero vectors, sets t to a large value, and initializes brdf to nullptr.
		 */
		 ...
		 * Initializes normal and position with given parameters, sets t to a large value, and initializes brdf to nullptr.
		 */
		...
		/**
		 * @brief Finalizes the surface interaction after the setting normal and position vectors by computing the orthonormal basis
		 */
		void finalize() {
