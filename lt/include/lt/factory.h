...
namespace LT_NAMESPACE {
	...
	public:
		...
		using  Creator = std::function<std::shared_ptr<T>()>;   		/**< Alias for creator function type. */
		using  CreatorRegistry = std::map<const std::string, Creator>; 	/**< Alias for registry of creators. */
