...
namespace LT_NAMESPACE {
	 ...
	 * 
	 * The Sensor class represents a sensor used to capture light data in a scene. It provides
	 * functionality for resetting the sensor, adding samples, setting samples, and retrieving
	 * the number of samples at a specific pixel.
	 */
	class Sensor
	{
	public:
		 ...
		 * 
		 * This function resets the accumulator, value, and count arrays of the sensor.
		 */
		void reset() {
