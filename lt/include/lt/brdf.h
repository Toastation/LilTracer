/**
 * @file brdf.h
 * @brief Defines classes related to Bidirectional Reflectance Distribution Functions (BRDFs).
 */
...
namespace LT_NAMESPACE {
	...
	/**
	 * @brief Base class for Bidirectional Reflectance Distribution Functions (BRDFs).
	 */
